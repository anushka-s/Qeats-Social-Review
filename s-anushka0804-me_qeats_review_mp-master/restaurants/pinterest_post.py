...
class Pinterest:
    ...
    def __init__(self):
        self.page_id = Pinterest.get_access_token('PINTEREST_BOARD_ID')
        self.page_access_token = Pinterest.get_access_token('PINTEREST_ACCESS_TOKEN')
...
# write your code below
    ...
    def publish_photo_msg(self, message, image_url):
        ...
        response = requests.post('https://api.pinterest.com/v1/pins', data=data)
        return response
